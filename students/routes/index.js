...
const { prcPage, prcApprovalController,prcReportApproval } = require('./controllers/prcController');
const { dcPage, dcApprovalController,dcReportApproval } = require('./controllers/dcController');
