...
for (var i=0;i<students.length;i++)
{
	...
	if (i%2 ==0)
		sql += `('${mainId}${i}','${students[i]}','INDIAN','${dob}','M','unmarried','${getParentName(students[i])}','${address}','${address}','9386373474','general','Jadavpur','Student','JU','${thesis}',5,'CSE0403',NULL,'ENGG04', '0017105010${getFormat(i+1)}', 'Y', NULL, '2021-05-06', '2026-05-06', NULL, NULL, 'N', '0', 'pic1', 5),`;
	else
		sql += `('${mainId}${i}','${students[i]}','INDIAN','${dob}','M','unmarried','${getParentName(students[i])}','${address}','${address}','9386373474','general','Jadavpur','Student','JU','${thesis}',5,'CSE0400',NULL,'ENGG04', '0017105010${getFormat(i+1)}', 'Y', NULL, '2021-05-06', '2026-05-06', NULL, NULL, 'N', '0', 'pic1', 5),`;
}
console.log(sql);
